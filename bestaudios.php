        ...
        <div class="multimedia-content-container">
            <div class="multimedia-content">
                ...
                while($row = get_array($result)) {
                    //print_r($row);
                    $media_id = $uploadedBy = $title = $description = $type = $extension = $path = $view_count = $time = $data_diff = $avg_rating = null;
                    $thumbnailSrc = "";
                    foreach ($row as $key => $value) {
                        ...
                        if($key == 'rating') $avg_rating = $value;
                    }
                        ...
                        <div class="text-wrapper">
                            <div class="media-rank">
                                ...
                                <div class="metadata">
                                    ...
                                    <span class="avg-rating">Avg rating: '. $avg_rating .'</span>
                                </div>
                            </div>
