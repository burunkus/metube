...
if (logged_in()) {
  ...
  $result = get_recently_uploaded($user, "isBlocked");
} else {
    $result = get_recently_uploaded();
}
?>
        ...
        <div class="multimedia-content-container">
            <div class="multimedia-content">
                ...
                while($row = get_array($result)) {
                    //print_r($row);
                    $media_id = $uploadedBy = $title = $description = $type = $extension = $path = $view_count = $time = $data_diff = null;
                    $thumbnailSrc = "";
